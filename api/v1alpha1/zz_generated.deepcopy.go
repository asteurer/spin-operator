...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OtelVar) DeepCopyInto(out *OtelVar) {
	*out = *in
	if in.ValueFrom != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OtelVar.
func (in *OtelVar) DeepCopy() *OtelVar {
	if in == nil {
		return nil
	}
	out := new(OtelVar)
